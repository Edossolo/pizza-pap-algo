                  ...
                  <Row>
                    ...
                    <Col>
                      ...
                      >
                        ...
                        <option value="Large">Large -- 2.0 ALGO</option>
                        <option value="Medium">Medium -- 1.5 ALGO</option>
                        <option value="Small">Small -- 1.0 ALGO</option>
                      </Form.Select>
                    </Col>
                  </Row>
                  <Row>
                    <Col>
                      ...
                      >
                        ...
                        <option value="Crispy">Crispy -- 0.5 ALGO</option>
                        <option value="Stuffed">Stuffed -- 0.5 ALGO</option>
                    ...
                    <Col>
                      <Form.Label className="mb-3">
                        Select Your Toppings at 0.1 ALGO each
                      </Form.Label>
                      <br />
